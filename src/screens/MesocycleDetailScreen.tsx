...
export function MesocycleDetailScreen({ navigation, route }: Props) {
  ...
  Alert.alert("Delete Mesocycle", "This will permanently delete this mesocycle and all linked data. This cannot be undone.", [
    { text: "Cancel", style: "cancel" },
    { text: "Delete", style: "destructive", onPress: () => deleteMeso.mutate(mesocycleId) },
  ]);
}} accent>
