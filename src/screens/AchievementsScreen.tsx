              ...
              <Card elevated accent="gold">
                <View style={{ flexDirection: "row", alignItems: "flex-start", gap: spacing.xl }}>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={{ color: mutedColor, fontSize: 11, lineHeight: 16, marginTop: spacing.sm }} numberOfLines={1}>
                      {nameForExercise(latestPr.exercise_id, lookup) ?? latestPr.exercise_id} • {recordValue(latestPr)}
                    </Text>
                      ...
                      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                        <View style={{ flexDirection: "row", alignItems: "center", gap: spacing.xl, flex: 1 }}>
                          ...
                          <View style={{ flex: 1 }}>
                            ...
                            <Text style={{ color: mutedColor, fontSize: 13, lineHeight: 16, marginBottom: spacing.xs }} numberOfLines={1}>
                              {nameForExercise(record.exercise_id, lookup) ?? record.exercise_id}
                            </Text>
